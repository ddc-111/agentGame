...
const routes = [
  ...
  { path: '/npc/behavior/:id?', component: () => import('./views/npc/BehaviorEditor.vue') },
  ...
  // 技能系统
  { path: '/skill/list', component: () => import('./views/skill/SkillEditor.vue') },
  { path: '/skill/tree', component: () => import('./views/skill/SkillEditor.vue') },

  // 成就系统
  { path: '/achievement/list', component: () => import('./views/achievement/AchievementEditor.vue') },

  // 演示系统
  { path: '/demo/player', component: () => import('./views/demo/DemoPlayer.vue') },

  // 系统配置
  { path: '/config/game', component: () => import('./views/config/GameConfig.vue') },
  { path: '/config/combat', component: () => import('./views/config/CombatConfig.vue') },
